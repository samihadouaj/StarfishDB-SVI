...
# delete Clangjit (source code and binaries)
rm -rf ${EXTERNALTOOLS_ABS_PATH}/llvm-project-cxxjit
rm -rf ${EXTERNALLIBS_ABS_PATH}/llvm-project-cxxjit

# delete Arrow (source code and binaries)
rm -rf ${EXTERNALTOOLS_ABS_PATH}/apache-arrow-9.0.0
rm -rf ${EXTERNALLIBS_ABS_PATH}/apache-arrow-9.0.0

# delete Mallet (source code and binaries)
rm -rf ${EXTERNALTOOLS_ABS_PATH}/mallet
rm -rf ${EXTERNALLIBS_ABS_PATH}/mallet

# delete lda_preprocess binaries
rm -rf ${EXTRASDIR_ABS_PATH}/lda_preprocess/build
