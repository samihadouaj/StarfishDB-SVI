...
int runMe(int argc, const char **argv)
{
   ...
   std::string test01DocwordFile = uciDatasetsDir+"/docword.test01.txt";
   std::string test01VocabFile = uciDatasetsDir+"/vocab.test01.txt";

   std::string test02DocwordFile = uciDatasetsDir+"/docword.test02.txt";
   std::string test02VocabFile = uciDatasetsDir+"/vocab.test02.txt";

   std::string test03DocwordFile = uciDatasetsDir+"/docword.test03.txt";
   std::string test03VocabFile = uciDatasetsDir+"/vocab.test03.txt";
